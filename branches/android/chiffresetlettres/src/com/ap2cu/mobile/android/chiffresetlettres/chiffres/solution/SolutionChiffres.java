package com.ap2cu.mobile.android.chiffresetlettres.chiffres.solution;
...
import com.ap2cu.mobile.android.chiffresetlettres.chiffres.operations.Operation;
  ...
  public void verifier() throws SolutionIncorrecteException {
    for (LigneDeCalcul ligne : lignes) {
      if (!ligne.estCorrecte())
        throw new SolutionIncorrecteException("Il y a une erreur de calcul � la ligne " + ligne);
    }
  }
