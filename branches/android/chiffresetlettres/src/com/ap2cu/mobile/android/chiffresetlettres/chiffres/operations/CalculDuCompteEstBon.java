package com.ap2cu.mobile.android.chiffresetlettres.chiffres.operations;
...
public final class CalculDuCompteEstBon {
  ...
  private int ecart; // ecart entre le resultat en cours et � trouver au cas ou
  // le compte est impossible
  private int resultatAAtteindre; // resultat � trouver
...
//    if (plaque[niveau][0] == resultatAAtteindre) {
    ...
    // si nous sommes au niveau 0 c'est que la solution n'a pas �t� trouv�e
    if (niveau == 0) {
      return;
    }
     ...
     * rang�e de plaque si des plaques sont identiques on traite plusieurs fois
     * les m�me combinaiasons cette boucle a pour but de ne traiter par la suite
     * que les combinaisons interessantes � traiter, elle ralentit le traitement
    ...
    // D�but du traitement de toutes les combinaisons //
    int compt = 0;
    while (combinaison[0][compt] != 0) {
      ...
      /*
       * maintenant on traite toutes les op�rations possible sur les 2 plaques
       * selectionn�es precedement
       */
      // ADDITION
