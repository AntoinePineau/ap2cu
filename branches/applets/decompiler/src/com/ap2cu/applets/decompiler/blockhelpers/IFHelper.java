...
package com.ap2cu.applets.decompiler.blockhelpers;
...
import com.ap2cu.applets.decompiler.core.*;
			...
			if (getGenericFinder().isThisInstrStart(j)
				...
				if ((k - j) == 6) {
					...
					if (info[s] == JvmOpCodes.LDC) {
						...
						if (offset < 0)
							offset += 256;
						com.ap2cu.applets.decompiler.constantpool.CPString constString = cd
