...
import com.ap2cu.applets.decompiler.constantpool.MethodInfo;
import com.ap2cu.applets.decompiler.core.LocalVariableHelper;
import com.ap2cu.applets.decompiler.exceptions.IOError;
...
public class Util {
	...
	public static void showUsage() throws IOException {
		com.ap2cu.applets.decompiler.io.Writer writer = com.ap2cu.applets.decompiler.io.Writer.getWriter("log");
		if (writer == null) {
	...
	public static java.lang.String[] decodeMethodSpecifiers(Integer code) {
		...
		case com.ap2cu.applets.decompiler.util.Constants.M_PUB_STATIC_FINAL_SYNCH_STRICT:
			numberOfSpecifiers = 5;
			specifiers = new java.lang.String[numberOfSpecifiers];
			specifiers[0] = "public";
			specifiers[1] = "static";
			...
			break;
		case com.ap2cu.applets.decompiler.util.Constants.M_PUB_STATIC_NATIVE:
			numberOfSpecifiers = 3;
			specifiers = new java.lang.String[numberOfSpecifiers];
			specifiers[0] = "public";
			specifiers[1] = "static";
			specifiers[2] = "native";
			break;
		case com.ap2cu.applets.decompiler.util.Constants.M_PUB_STATIC_STRICT:
			numberOfSpecifiers = 3;
			specifiers = new java.lang.String[numberOfSpecifiers];
			specifiers[0] = "public";
			specifiers[1] = "static";
