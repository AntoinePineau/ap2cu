package com.ap2cu.mobile.android.chiffresetlettres.chiffres.tirage;

import java.util.List;
import java.util.Vector;

import com.ap2cu.mobile.android.chiffresetlettres.chiffres.operations.CalculDuCompteEstBon;
import com.ap2cu.mobile.android.chiffresetlettres.chiffres.operations.LigneDeCalcul;
...
public class TirageChiffres extends Tirage {
  ...
  public void verifierSolutionProposee(Solution solution) throws SolutionIncorrecteException {
    ...
    // v�rifier que ce calcul utilise des nombres autoris�s
    ...
    for (LigneDeCalcul ligne : calcul.getLignes()) {
      ...
      if (!op1_trouve || !op2_trouve) {
        throw new SolutionIncorrecteException("Des nombres non-autoris�es ont �t� choisis");
      }
    }

    // v�rifier qu'il n'y a pas d'erreur de calcul
    calcul.verifier();
  }
