...
public class Dictionnaire {
  ...
  protected Dictionnaire(Locale locale, boolean autoriserNomsPropres) throws DictionnaireException {
    this("com/ap2cu/mobile/android/chiffresetlettres/lettres/dico/config/" + locale.getLanguage() + ".dic", 9, autoriserNomsPropres);
  }
  ...
  public void sauver() throws DictionnaireException {
    if (debut != null) {
      try {
        ...
        throw new DictionnaireException("Le dictionnaire n'a pas pu �tre sauv� dans " + fichierDictionnaire, e);
      }
      modifie = false;
    }
  }
